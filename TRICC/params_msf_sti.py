...
inputfile_dx = folder+'diagrams/diagnostic_v2.drawio'  # inputfile for jupyter notebook diagnostic
inputfile = folder+'diagrams/tt.drawio' # inputfile for tricc-graph tt
